...
-- ICONS BASE64 (funciona em todos executores)
local ArrowIcon = "rbxassetid://6034818372"
...
function library:Window(WindowArgs)
    ...
    function WindowTable:ToggleMinimize()
        isMinimized = not isMinimized
        if isMinimized then
            -- Minimizar - mostrar apenas a barra inferior
            Utilities:Tween(Window.Main, .25, {Size = UDim2.new(0, Window.Main.AbsoluteSize.X, 0, 24)}, Enum.EasingStyle.Quad)
        else
            -- Maximizar - voltar ao tamanho normal
            Utilities:Tween(Window.Main, .25, {Size = UDim2.new(0, Window.Main.X.Value, 0, Window.Main.Y.Value)}, Enum.EasingStyle.Quad)
        end
    end

    bottomText.MinimizeButton.MouseButton1Click:Connect(function() 
        WindowTable:ToggleMinimize() 
    end)

    -- PROTEÇÃO DA GUI (UNIVERSAL)
    ...
    local function ResizeTabs()
        local TabSize = 1 / math.max(self.Tabs, 1)
        task.spawn(function()
            for _, v in pairs(TabContainer:GetChildren()) do
                if v.ClassName == "Frame" then v.Size = UDim2.new(TabSize, 0, 0, 26) end
            end
        end)
    end
    ...
    function WindowTable:Exit() Window:Destroy() end
    function WindowTable:Toggle() Window.Enabled = not Window.Enabled end
    ...
    function WindowTable:Tab(TabArgs)
        ...
        local ContainerHolder = Utilities:Create("Frame", {
            ...
            Parent = Containers,
            BackgroundTransparency = 1
        }, { Utilities:Create("UIListLayout", { FillDirection = Enum.FillDirection.Horizontal }) })
        ...
        }, { Utilities:Create("UIListLayout"), Utilities:Create("UIPadding", { PaddingLeft = UDim.new(0, 8) }) })
        ...
        }, { Utilities:Create("UIListLayout"), Utilities:Create("UIPadding", { PaddingLeft = UDim.new(0, 6) }) })
            ...
            task.spawn(function()
                for _, v in pairs(Containers:GetChildren()) do
                    if v.Name == "ContainerHolder" then
                        if v.Left ~= Left then v.Left.Visible = false; v.Right.Visible = false end
                    end
                end
                for _, v in pairs(TabContainer:GetChildren()) do
        ...
        Tab.TabButton.MouseButton1Click:Connect(function() TabTable:Select() end)
        ...
        function TabTable:Section(SectionArgs)
            ...
            local Section = Utilities:Create("Frame", {
                ...
                }, { Utilities:Create("UIListLayout", { SortOrder = Enum.SortOrder.LayoutOrder }) })
            })
            ...
            function SectionTable:Check(CheckArgs)
                ...
                local Check = Utilities:Create("Frame", {
                    ...
                    Utilities:Create("TextButton", { Name = "CheckButton", Size = UDim2.new(0, 14, 0, 14), BackgroundTransparency = 1 }),
                    Utilities:Create("Frame", { Name = "CheckFrame", Size = UDim2.new(0, 14, 0, 14), BackgroundTransparency = 1 }, {
                        Utilities:Create("TextLabel", {
                            Name = "CheckText", Text = CheckArgs.Text, TextSize = 13, RichText = true,
                            Font = Enum.Font.SourceSansBold, Size = UDim2.new(0, 14, 0, 14),
                            TextXAlignment = Enum.TextXAlignment.Left, Position = UDim2.new(0, 20, 0, 0),
                            TextColor3 = Colors.PrimaryText, BackgroundTransparency = 1
                        }),
                        Utilities:Create("Frame", {
                            Name = "CheckInner", AnchorPoint = Vector2.new(.5, .5),
                            Position = UDim2.new(.5, 0, .5, 0), Size = UDim2.new(0, 12, 0, 12),
                            BackgroundColor3 = Colors.Secondary
                        }),
                ...
                local ButtonSize = TextBounds.X + 20
                ...
                function CheckTable:Set(bool)
                    ...
                    State = bool
                    if CheckArgs.Flag ~= nil then library.Flags[CheckArgs.Flag] = bool end
                    if State then
                ...
                CheckButton.MouseButton1Click:Connect(function() State = not State; CheckTable:Set(State) end)
                if CheckArgs.Default then CheckTable:Set(true) end
                return CheckTable
            end
            ...
            function SectionTable:Button(Info)
                ...
                local Button = Utilities:Create("Frame", {
                    Name = "Button", Parent = SectionContainer,
                    Size = UDim2.new(0, 286, 0, 21), BackgroundTransparency = 1
                }, {
                    Utilities:Create("Frame", { Name = "ButtonFrame", BackgroundColor3 = Colors.Secondary, Size = UDim2.new(0, 14, 0, 14) }, {
                        Utilities:Create("UIStroke", { Color = Colors.Divider }),
                        Utilities:Create("TextLabel", {
                            Name = "ButtonText", Size = UDim2.new(1, 0, 1, 0), Text = Info.Text,
                            RichText = true, Font = Enum.Font.SourceSansBold, BackgroundTransparency = 1,
                            TextSize = 13, TextColor3 = Colors.PrimaryText
                        }),
                        Utilities:Create("TextButton", { Name = "ButtonButton", Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 })
                    })
                })
                ...
                Button.ButtonFrame.ButtonButton.MouseButton1Up:Connect(function()
                    ...
                    if Hovering then Utilities:Tween(Button.ButtonFrame.UIStroke, .125, {Color = Colors.AccentDivider})
                    else Utilities:Tween(Button.ButtonFrame.UIStroke, .125, {Color = Colors.Divider}) end
                end)
                Button.ButtonFrame.ButtonButton.MouseButton1Click:Connect(function() task.spawn(Info.Callback) end)
            end
            ...
            function SectionTable:Slider(Info)
                ...
                for i = 1, 10 do
                    ...
                    StepFormat = '%.' .. i .. 'f'
                    if StepFormat:format(Step) == tostring(Step) then break end
                end

                local Slider = Utilities:Create("Frame", {
                    Name = "Slider", Parent = SectionContainer,
                    Size = UDim2.new(0, 286, 0, 21), BackgroundTransparency = 1
                }, {
                    Utilities:Create("Frame", { Name = "SliderOuter", BackgroundColor3 = Colors.Secondary, Size = UDim2.new(.6, 3, 0, 14) }, {
                        Utilities:Create("UIStroke", { Color = Colors.AccentDivider }),
                        Utilities:Create("Frame", { Name = "SliderInner", BackgroundColor3 = Colors.DarkerAccent, Size = UDim2.fromScale(DefaultScale, 1) }),
                        Utilities:Create("TextLabel", {
                            Name = "SliderValueText", Text = StepFormat:format(Rounded)..Info.Postfix,
                            TextSize = 13, Font = Enum.Font.SourceSansBold, RichText = true,
                            Size = UDim2.new(1, 0, 0, 14), TextColor3 = Color3.fromRGB(255, 255, 255), BackgroundTransparency = 1
                        }),
                        Utilities:Create("TextButton", { Name = "SliderButton", Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 }),
                        Utilities:Create("TextLabel", {
                            Name = "SliderText", Text = Info.Text, TextSize = 13, Font = Enum.Font.SourceSansBold,
                            RichText = true, Size = UDim2.new(1, 0, 0, 14), TextXAlignment = Enum.TextXAlignment.Left,
                            Position = UDim2.new(1, 6, 0, 0), TextColor3 = Colors.PrimaryText, BackgroundTransparency = 1
                        })
                    })
                })

                SizeX:GetPropertyChangedSignal("Value"):Connect(function()
                    Slider.Size = UDim2.new(0, SizeX.Value / 2 - 14, 0, 21)
                end)
                ...
                Slider.SliderOuter.SliderButton.MouseButton1Down:Connect(function()
                    ...
                    MouseMove = Mouse.Move:Connect(function()
                        ...
                        if Info.Flag then library.Flags[Info.Flag] = FinalValue end
                    ...
                    MouseKill = UserInputService.InputEnded:Connect(function(UserInput)
                        if UserInput.UserInputType == Enum.UserInputType.MouseButton1 then
                            MouseMove:Disconnect(); MouseKill:Disconnect()
                        end
                    end)
                end)
            ...
            function SectionTable:Label(Info)
                ...
                local Label = Utilities:Create("Frame", {
                    Name = "Label", Parent = SectionContainer,
                    Size = UDim2.new(0, 286, 0, 21), BackgroundTransparency = 1
                }, {
                    Utilities:Create("TextLabel", {
                        Name = "LabelText", Text = Info.Text, TextColor3 = Info.Color, RichText = true,
                        BackgroundTransparency = 1, Size = UDim2.new(0, 286, 0, 14),
                        TextXAlignment = Enum.TextXAlignment.Left, TextSize = 13, Font = Enum.Font.SourceSansBold
                    })
                })
            ...
            function SectionTable:Dropdown(Info)
                ...
                local Dropdown = Utilities:Create("Frame", {
                    Name = "Dropdown", BackgroundTransparency = 1, Parent = SectionContainer, Size = UDim2.new(0, 286, 0, 21)
                }, {
                    Utilities:Create("Frame", {
                        Name = "DropdownFrame", Size = UDim2.new(.6, 3, 0, 14),
                        BackgroundColor3 = Colors.Secondary, ClipsDescendants = true, ZIndex = DropdownTable.Index
                    }, {
                        Utilities:Create("UIStroke", { Color = Colors.AccentDivider }),
                        Utilities:Create("TextLabel", {
                            Name = "DropdownText", BackgroundTransparency = 1, Text = Info.Text,
                            Size = UDim2.new(1, 0, 0, 14), TextXAlignment = Enum.TextXAlignment.Left,
                            RichText = true, Position = UDim2.new(0, 4, 0, 0), TextSize = 13,
                            TextColor3 = Colors.TertiaryText, Font = Enum.Font.SourceSansBold, ZIndex = DropdownTable.Index
                        }),
                        Utilities:Create("TextButton", { Name = "DropdownButton", BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 14), ZIndex = DropdownTable.Index }),
                        Utilities:Create("Frame", {
                            Name = "DropdownContainer", Size = UDim2.new(1, 0, 0, 0), BackgroundTransparency = 1,
                            ClipsDescendants = true, Position = UDim2.new(0, 0, 0, 14), ZIndex = DropdownTable.Index
                        }, { Utilities:Create("UIListLayout") }),
                        Utilities:Create("Frame", {
                            Name = "GradientHolder", Size = UDim2.new(0, 20, 0, 14), BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                            Position = UDim2.new(1, -41, 0, 0), ZIndex = DropdownTable.Index
                        }, {
                            Utilities:Create("UIGradient", {
                                Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, Colors.Secondary), ColorSequenceKeypoint.new(1, Colors.Secondary) }),
                                Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 1), NumberSequenceKeypoint.new(1, 0) })
                            })
                        }),
                        Utilities:Create("Frame", {
                            Name = "DropdownImageContainer", Size = UDim2.new(0, 21, 0, 14), BackgroundColor3 = Colors.Tertiary,
                            Position = UDim2.new(1, -21, 0, 0), ZIndex = DropdownTable.Index
                        }, {
                            Utilities:Create("UIStroke", { Color = Colors.AccentDivider }),
                            Utilities:Create("ImageLabel", {
                                Name = "DropdownImage", Size = UDim2.new(0, 10, 0, 10), BackgroundTransparency = 1,
                                Rotation = 0, Image = ArrowIcon, AnchorPoint = Vector2.new(.5, .5),
                                Position = UDim2.new(.5, 0, .5, 0), ZIndex = DropdownTable.Index
                            })
                        })
                    })
                })
                ...
                SizeX:GetPropertyChangedSignal("Value"):Connect(function()
                    Dropdown.Size = UDim2.new(0, SizeX.Value / 2 - 14, 0, 21)
                end)
                Dropdown.DropdownFrame.MouseEnter:Connect(function()
                    if not State then Utilities:Tween(Dropdown.DropdownFrame, .125, {BackgroundColor3 = Colors.Hovering}) end
                end)
                Dropdown.DropdownFrame.MouseLeave:Connect(function()
                    if not State then Utilities:Tween(Dropdown.DropdownFrame, .125, {BackgroundColor3 = Colors.Secondary}) end
                end)
                ...
                if Info.Default then
                    ...
                    if Info.ChangeText then Dropdown.DropdownFrame.DropdownText.Text = Info.Default end
                end

                function DropdownTable:Select(v)
                    task.spawn(Info.Callback, v)
                    if Info.Flag then library.Flags[Info.Flag] = v end
                    if Info.ChangeText then Dropdown.DropdownFrame.DropdownText.Text = v end
                end
                    ...
                    if Info.Multi then
                        if not table.find(MultiTable, v.DropdownElementText.Text) then
                            ...
                            for i, e in pairs(MultiTable) do
                                if v.DropdownElementText.Text == e then table.remove(MultiTable, i) end
                            end
                        end
                ...
                function DropdownTable:Refresh(tbl)
                    ...
                    for _, v in pairs(tbl) do DropdownTable:Add(v) end
                end
                ...
                function DropdownTable:Add(str)
                    ...
                    local DropdownElement = Utilities:Create("Frame", {
                        Name = "DropdownElement", Size = UDim2.new(1, 0, 0, 14), Parent = DropdownContainer,
                        BackgroundTransparency = 1, ZIndex = DropdownTable.Index
                    }, {
                        Utilities:Create("TextLabel", {
                            Name = "DropdownElementText", Text = str, Size = UDim2.new(1, 0, 1, 0), TextSize = 13,
                            BackgroundTransparency = 1, RichText = true, TextColor3 = Colors.PrimaryText,
                            Font = Enum.Font.SourceSansBold, ZIndex = DropdownTable.Index
                        }),
                        Utilities:Create("TextButton", {
                            Name = "DropdownElementButton", Size = UDim2.new(1, 0, 1, 0),
                            BackgroundTransparency = 1, ZIndex = DropdownTable.Index
                        })
                    })
                    ...
                    DropdownElement.DropdownElementButton.MouseButton1Click:Connect(function() OnPick(DropdownElement) end)
                end

                for _, v in pairs(Info.List) do DropdownTable:Add(v) end

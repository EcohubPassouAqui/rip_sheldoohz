...
library.theme = {
    ...
    -- TOGGLE / SLIDER ATIVO (ROSA)
    accentcolor = Color3.fromRGB(255, 60, 180),
    accentcolor2 = Color3.fromRGB(180, 40, 130),

    outlinecolor = Color3.fromRGB(45, 45, 45),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),

    sectorcolor = Color3.fromRGB(18, 18, 18),
    ...
    buttoncolor2 = Color3.fromRGB(15, 15, 15),
